...
class RecipeSerializer(serializers.ModelSerializer):
    """
    Сериализатор для детального представления рецептов (для чтения).
    """
    ...
    def get_is_favorited(self, recipe):
        """Проверяем, добавлен ли рецепт в избранное у текущего пользователя."""
        return self._is_in_list(recipe, Favorite)

    def get_is_in_shopping_cart(self, recipe):
        """Проверяем, добавлен ли рецепт в список покупок у текущего пользователя."""
...
class RecipeWriteSerializer(serializers.ModelSerializer):
    """
    Сериализатор для создания и обновления рецептов (для записи).
    """
    ...
    def to_representation(self, instance):
        """При ответе после создания/обновления используем подробный сериализатор."""
